...
<article>
	...
	보호되고 있으니 안심하고 이용하시기 바랍니다.<br><br> 
	
	<textarea rows="15" cols="100">
	제 1 장 총 칙
제 1 조 (목적)
이 이용약관(이하 '약관')은 주식회사 Shoes Shop(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 shoes shop.com서비스의 가입조건 및 이용에 관한 다음의 제반 사항과 기타 기본적인 사항을 구체적으로 규정함을 목적으로 합니다.
